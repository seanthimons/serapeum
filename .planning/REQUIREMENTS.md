...
- [ ] **THEM-01**: Sidebar colors adapt correctly to both light and dark mode (#137)
- [ ] **THEM-02**: Citation audit button is readable in light mode (#137)
- [ ] **THEM-03**: Import papers button has a distinct color from primary buttons (#137)
- [ ] **THEM-04**: Abstract notebook buttons follow global theme — either all icons or all icon+text, consistent hover states (#139)
- [ ] **THEM-05**: Button bar uses available title bar space effectively (#139)
