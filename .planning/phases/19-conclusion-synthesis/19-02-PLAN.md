...
must_haves:
  truths:
    - "User can click Conclusions preset button in document notebook chat"
    - "User can click Conclusions preset button in search notebook chat"
    - "Synthesis output shows prominent AI-generated content disclaimer"
    - "Synthesis aggregates positions across papers with citations"
